...
function toArray(text) {
  ...
  return (0, _stringReplaceToArray2.default)(text.replace(asciiAliasesRegex, replaceAsciiAliases).replace(aliasesRegex, replaceAliases).replace(regex, function (match) {
  ...
  }), unicodeEmojiRegex, replaceUnicodeEmoji);
}
